...
export default function Dropdown() {
  ...
  return (
    <Menu as="div" className="w-24 h-12 relative flex items-center">
      ...
      >
        <Menu.Items className="absolute right-0 w-36 mt-24 origin-top-right bg-[#1A1A1A] divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
