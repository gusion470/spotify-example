...
function Poster({ track, chooseTrack }) {
  ...
  return (
    <div
      className="w-[150px] h-[250px] md:w-[220px] md:h-[320px] rounded-[50px] overflow-hidden relative text-white/80 cursor-pointer hover:scale-105 hover:text-white/100 transition duration-200 ease-out group mx-auto "
      onClick={handlePlay}
    >
      <img
        src={track.albumUrl}
        alt=""
        className="h-full w-full absolute inset-0 object-cover rounded-[25px] opacity-80 group-hover:opacity-100"
      />
